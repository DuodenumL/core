...
// doLoadProcessingCount returns how many workloads are `processing` on each node
func (r *Rediaron) doLoadProcessingCount(ctx context.Context, appname, entryname string) (map[string]int, error) {
